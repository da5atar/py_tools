...
This script generates a README markdown file for a GitHub repository based on user input.
To run the script, simply execute it and provide the required information when prompted.
'''
def generate_markdown_file():
    """
    Generate a README markdown file for a GitHub repository based on user input.
    """
...
def select_license():
    """
    Prompt the user to select a license for the project.
    """
    licenses = {
        "MIT": "MIT License",
