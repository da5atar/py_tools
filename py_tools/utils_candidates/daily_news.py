'''
daily_news.py
This script fetches and displays the following daily updates:
1. Trending news headlines
2. Horoscope for a specific zodiac sign
3. Historical events that happened on this day

The information is displayed in a scrollable Tkinter window with sections for each update.

To run the script, simply execute it. The daily updates will be displayed in a popup window.

You can customize the script by changing the following:
1. The API key for fetching news headlines (replace 'CREATE_YOUR_OWN').
2. The zodiac sign for which you want to fetch the horoscope.
3. The number of historical events to display.

Note: You need to install the 'requests' and 'beautifulsoup4' libraries to run this script.
'''
